  ...
  return (
    <section className="px-2 py-10 md:px-8 mt-10 max-w-3xl mx-auto font-sans text-gray-800 text-lg">
      <p className="mb-6 leading-relaxed text-justify">
        ...
        reinforces a subjugating role, masking inequality as complementarity. 
      </p>

      <img
        src="https://img.freepik.com/free-vector/retro-cartoon-civil-rights-stickers-collection_23-2151115005.jpg"
        alt="motherhood"
      ...
      <div className="mb-6 text-justify space-y-4">
        <p>
            Why men are the head that needs balancing from a woman being the neck is never truly explained—we just know that men 
            lead while women support. And this has been one of the biggest structures of patriarchy: the one in the family. 
            Anthropologists even argue it might have been how patriarchy and women’s subjugation came about in the first place.
        </p>
        <p>
            Anthropologists found that in early human societies, humans lived as hunters and gatherers with a division of labour—men typically 
            hunted due to their greater physical strength, while women mostly gathered. 
            Because of their reproductive roles, women were often confined to child-rearing, a reality that men eventually exploited.
        </p>
        <p>
            Over time, the idea of owning private property developed, which led to the the creation of marriage as an institution, 
            allowing men to claim women as part of their property, and thus patriarchy was born, with men positioned as the “head” of the household.
        </p>
      </div>

      <img
        src="https://img.freepik.com/free-vector/modern-feminism-concept-with-flat-design_23-2147958605.jpg"
        alt="motherhood"
        className="w-full max-w-3xl mx-auto rounded-lg mb-6"
      />
      ...
      <div className="mb-6 text-justify space-y-4">
        <p>
            ...
            Loving one’s spouse was and still is considered more difficult than surrendering one's autonomy, simply because it is men who were asked to do it.
        </p>
        <p>
      ...
      <img
        src="https://img.freepik.com/premium-vector/set-doodle-signs-feminism-women-s-rights-grunge-hand-drawn-vector-icons-feminism-protest_497982-335.jpg"
        alt="motherhood"
        className="w-full max-w-3xl mx-auto rounded-lg mb-6"
      />
...
export default WhyCantMothersHeadTheHome;
