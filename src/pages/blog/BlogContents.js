  ...
  return (
    <section>
        <div className="text-center px-5">
          <p>
            With Juneteenth around the corner, a day set aside to commemorate the emancipation of Black people, 
        ...
        <div className="">
          <img src="https://i.pinimg.com/736x/e6/f3/46/e6f346a7802e21ab6aecffb4f3501795.jpg" alt="women who inspire"/>
        </div>
        <div classsName=''>
          <p>
        ...
        <div className="">
          <img src="https://www.cms.qazini.com/uploads/African_women_rise_up_in_Forbes_Most_Powerful_Women_rankings_01_84ece97a69_eeb0485292.jpg" alt="women who inspire"/>
        </div>
        <div className="">
          <p>
          ...
          <p>
            Here are just a few of the many Black women who have made inspiring contributions to the fight for liberation:
          </p>
        </div>
        <div className="">
          <img src="https://i.pinimg.com/736x/c7/c2/ea/c7c2ea3b3008e0c9b2990f15360cfd10.jpg" alt="women who inspire"/>
        </div>
          <div className="">
            <p>
              <span className="font-semibold">Harriet Tubman (1822-1913):</span>Harriet Tubman was an American abolitionist who escaped slavery and went on to rescue 
          ...
          <div>
            <img src="https://i.pinimg.com/736x/3f/3f/3d/3f3f3d01f18692517a04c8625d0623f4.jpg" alt="women who inspire"/>
          </div>
          <div className="">
            <p>
              <span className="font-semibold">Rosa Parks (1913 - 2005): </span>Rosa Parks was an American civil rights activist 
          ...
          <div className="">
            <img src="https://bapproduction.com/wp-content/uploads/2024/04/Chief-Funmilayo-Ransome-Kuti-.png" alt="women who inspire"/>
          </div>
          <div className="">
            <p>
              <span className="font-semibold">Funmilayo Ransom-Kuti (1900 - 1978): </span>Funmilayo Ransome-Kuti is often 
              reduced to a fun fact, that she was the first Nigerian woman to drive a car. But that car wasn't just for show. 
          ...
          <div className="">
            <img src="https://i.pinimg.com/736x/b1/b3/7a/b1b37a9c8337f39f57b3fba917551707.jpg" alt="women who inspire"/>
          </div>
          <div className="">
            <p>
              <span className="font-semibold">Sojourner Truth (1797 - 1883):</span>Sojourner Truth is mostly remembered for 
              her famous speech “Ain’t I a Woman?”, but she was much more than just that. Born into slavery, she escaped and 
          ...
          <div className="">
            <img src="https://i.pinimg.com/736x/51/0e/22/510e22db1203e9b25f8c2551a1f4967a.jpg" alt="women who inspire"/>
          </div>
          <div className="" >
            <h2>Conclusion</h2><br />
            <p>
